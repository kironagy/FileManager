...
class TranslationTable extends TableAbstract
{
    ...
    public function setup(): void
    {
        ...
        $this
            ->addHeaderActions([
                ExportHeaderAction::make()->route('tools.data-synchronize.export.translations.index')->permission('translations.export'),
                ImportHeaderAction::make()->route('tools.data-synchronize.import.translations.index')->permission('translations.import'),
            ])
            ->onAjax(function () {
    ...
    public function getFilters(): array
    {
        return [
            'group' => SelectBulkChange::make()
                ->name('group')
                ->title(trans('packages/translation::translation.group'))
        ...
        return [
            FormattedColumn::make('group')
                ...
                ->getValueUsing(function (FormattedColumn $column) {
                    ...
                    if (Str::startsWith($group, 'core/') || Str::startsWith($group, 'packages/')) {
                    ...
                    } elseif (Str::startsWith($group, 'packages/')) {
                        $plugin = Str::beforeLast(Str::after($group, 'packages/'), '/');
                        ...
                        if ($plugin !== $name) {
                            ...
                            $groupDisplay = $name . ' (' . Str::beforeLast(Str::after($group, 'packages/'), '/') . ')';
                        } else {
            ...
            FormattedColumn::make('value')
                ...
                ->getValueUsing(function (FormattedColumn $column) {
                    ...
                    return Html::link('#edit', $value, [
                        ...
                        'data-type' => 'textarea',
                        'data-pk' => $item->key,
                        'data-title' => trans('packages/translation::translation.edit_title'),

...
class LocaleController extends SettingController
{
    protected function breadcrumb(): Breadcrumb
    {
        return parent::breadcrumb()
            ->add(trans('packages/translation::translation.locales'), route('translations.locales'));
    }

    public function index()
    {
        $this->pageTitle(trans('packages/translation::translation.locales'));

        Assets::addScriptsDirectly('vendor/core/packages/translation/js/locales.js');
        ...
        return view('packages/translation::locales', compact('existingLocales', 'locales', 'flags'));
    }

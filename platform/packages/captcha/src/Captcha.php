...
class Captcha extends CaptchaContract
{
    ...
    public function display(array $attributes = [], array $options = []): ?string
    {
        ...
        return
            tap(
                view('packages/captcha::v2.html', ['name' => $name, 'siteKey' => $this->siteKey])->render(),
    ...
    {
        return view('packages/captcha::header-meta')->render();
    }
    ...
    protected function footerRender(string $name): string
    {
        ...
        return view('packages/captcha::v2.script', compact('url', 'isRendered', 'name'))->render();
    }
}
